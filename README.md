...
<p align="center">
    <a href="https://xyo.financial" target="_blank">
        <img width="420" alt="Java Mascot for XYO.Financial" src="docs/mascot.png" />
    </a>
    <br />
    <sup>Java Mascot for XYO.Financial Generated by Gemini and Imagined by Syniol Limited</sup>
</p>
...
# Compile and execute the full test suite (27 unit & integration boundary tests)
mvn clean test
